...
class RedfinScraper:
    ...
    def setup(self, zip_database_path: str = rsrj.get_config_value('zip_database_path'),
              multiprocessing: bool = rsrj.get_config_value('multiprocessing')):
    ...
    def _select_zip_codes(self, city_state, lat_tuner, lon_tuner):
        ...
        city_df = self.zip_database[
            (self.zip_database['city'].str.contains(city_state[0].title()))
            & (self.zip_database['state_name'] == city_state[1].upper())]
